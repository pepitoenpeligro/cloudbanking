...
./mvnw package
```
It produces the `funds-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/funds-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/funds-1.0.0-SNAPSHOT-runner`
